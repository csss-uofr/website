...
const HeroSection = () => {
  return (
    <>
      <div className="container flex flex-col justify-center h-80 border-gray-300 border-b py-4 bg-">
        ...
        <div className="mt-6 text-center">
          <p>
            ...
            for undergraduates at the <Link className="text-green-500 hover:underline" to="#">University of Regina Department of Computer Science </Link>. We
            ...
            media outlets. Join us on  <Link className="text-green-500 hover:underline" to="#">Discord </Link> or <Link className="text-green-500 hover:underline" to="#"> Instagram!</Link>
          </p>
        </div>
      </div>
    </>
